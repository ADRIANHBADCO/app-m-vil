...
import 'package:app_veterinaria/src/authenticated/profile/info/categories/create/pet_categories_controller.dart';



class PetCategories extends StatelessWidget {
   PetCategoriesController con = Get.put(PetCategoriesController());
